...
// Source File Name:   PrintUtils.java
...
public class PrintUtils
{
    ...
    public static Serializable validate(Class cls, String value)
    ...
    public static final String[] beautify2DArray(String as)
    {
        String sep = "}";
        StringTokenizer tokenizer = new StringTokenizer(as, sep);
        Vector v = new Vector();
        for(; tokenizer.hasMoreTokens(); v.add(tokenizer.nextToken()));
        return (String[])(String[])(String[])v.toArray(new String[0]);
    }

    public static final void display2DArray(String indent, Object array)
    {
        String bl[] = beautify2DArray(arrayToString(array, ", "));
        if(1 == bl.length && 1 == bl[0].length())
        {
            System.out.println("{ }");
        } else
        {
            ...
            {
                if(j != 0)
                    System.out.print((new StringBuilder()).append(indent).append(bl[j].substring(2)).toString());
                else
                    System.out.print((new StringBuilder()).append(indent.substring(1)).append(bl[j]).toString());
                if(j != bl.length - 1)
                    System.out.println("},");
                else
                    System.out.println("}}");
