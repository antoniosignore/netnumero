...
public class LocalizableMessages_en implements com.numhero.client.LocalizableMessages {
  ...
  public java.lang.String currentDate(java.util.Date arg0) {
    return com.google.gwt.i18n.client.DateTimeFormat.getLongDateFormat().format(arg0) + " " + com.google.gwt.i18n.client.DateTimeFormat.getMediumTimeFormat().format(arg0);
  }
