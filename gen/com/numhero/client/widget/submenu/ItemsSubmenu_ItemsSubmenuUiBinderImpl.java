...
public class ItemsSubmenu_ItemsSubmenuUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.numhero.client.widget.submenu.ItemsSubmenu>, com.numhero.client.widget.submenu.ItemsSubmenu.ItemsSubmenuUiBinder {
  ...
  interface Template extends SafeHtmlTemplates {
    @Template("<dl class='inh-menu'> <dt class='inh-menu'> <a class='inh-menu' href='#product'> {0} </a> </dt> <dt class='inh-menu'> <a class='inh-menu' href='#products'> {1} </a> </dt> <dt class='inh-menu'> <a class='inh-menu' href='#service'> {2} </a> </dt> <dt class='inh-menu-end'> <a class='inh-menu' href='#services'> {3} </a> </dt> </dl>")
