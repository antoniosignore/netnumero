...
public class ReportBugPanel_MoneyinPanelUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.numhero.client.mvp.reportbug.ReportBugPanel>, com.numhero.client.mvp.reportbug.ReportBugPanel.MoneyinPanelUiBinder {
  static ReportBugPanelMoneyinPanelUiBinderImplGenMessages messages = (ReportBugPanelMoneyinPanelUiBinderImplGenMessages) GWT.create(ReportBugPanelMoneyinPanelUiBinderImplGenMessages.class);
  ...
  interface Template extends SafeHtmlTemplates {
    ...
    @Template("<span id='{0}'></span> <br> <span id='{1}'></span> <span id='{2}'></span>")
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.numhero.client.mvp.reportbug.ReportBugPanel owner) {

    com.numhero.client.mvp.reportbug.ReportBugPanel_MoneyinPanelUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.numhero.client.mvp.reportbug.ReportBugPanel_MoneyinPanelUiBinderImpl_GenBundle) GWT.create(com.numhero.client.mvp.reportbug.ReportBugPanel_MoneyinPanelUiBinderImpl_GenBundle.class);
    com.numhero.client.mvp.reportbug.ReportBugPanel_MoneyinPanelUiBinderImpl_GenCss_style style = clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay.style();
