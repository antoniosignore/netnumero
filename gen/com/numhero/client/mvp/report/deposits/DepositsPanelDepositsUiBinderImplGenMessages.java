...
@GeneratedFrom("com/numhero/client/mvp/report/deposits/DepositsPanel.ui.xml")
@DefaultLocale("en")
@GenerateKeys("com.google.gwt.i18n.rebind.keygen.MD5KeyGenerator")
@Generate(
  format = {"com.google.gwt.i18n.rebind.format.PropertiesFormat", },
  fileName = "LedgerAccountPanel",
  locales = {"default", }
)
public interface DepositsPanelDepositsUiBinderImplGenMessages extends com.google.gwt.i18n.client.Messages {
