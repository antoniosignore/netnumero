...
public class DepositsPanel_DepositsUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, com.numhero.client.mvp.report.deposits.DepositsPanel>, com.numhero.client.mvp.report.deposits.DepositsPanel.DepositsUiBinder {
  static DepositsPanelDepositsUiBinderImplGenMessages messages = (DepositsPanelDepositsUiBinderImplGenMessages) GWT.create(DepositsPanelDepositsUiBinderImplGenMessages.class);
  ...
  public com.google.gwt.user.client.ui.HTMLPanel createAndBindUi(final com.numhero.client.mvp.report.deposits.DepositsPanel owner) {

    com.numhero.client.mvp.report.deposits.DepositsPanel_DepositsUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.numhero.client.mvp.report.deposits.DepositsPanel_DepositsUiBinderImpl_GenBundle) GWT.create(com.numhero.client.mvp.report.deposits.DepositsPanel_DepositsUiBinderImpl_GenBundle.class);
    java.lang.String domId0 = com.google.gwt.dom.client.Document.get().createUniqueId();
    java.lang.String domId1 = com.google.gwt.dom.client.Document.get().createUniqueId();
    com.numhero.client.mvp.report.deposits.DepositsTable depositsTable = (com.numhero.client.mvp.report.deposits.DepositsTable) GWT.create(com.numhero.client.mvp.report.deposits.DepositsTable.class);
    ...
    f_HTMLPanel2.addAndReplaceElement(depositsTable, domId1Element);
    ...
    owner.depositsTable = depositsTable;
