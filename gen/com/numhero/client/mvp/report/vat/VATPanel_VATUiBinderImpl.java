...
public class VATPanel_VATUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, com.numhero.client.mvp.report.vat.VATPanel>, com.numhero.client.mvp.report.vat.VATPanel.VATUiBinder {
  static VATPanelVATUiBinderImplGenMessages messages = (VATPanelVATUiBinderImplGenMessages) GWT.create(VATPanelVATUiBinderImplGenMessages.class);
  ...
  public com.google.gwt.user.client.ui.HTMLPanel createAndBindUi(final com.numhero.client.mvp.report.vat.VATPanel owner) {

    com.numhero.client.mvp.report.vat.VATPanel_VATUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.numhero.client.mvp.report.vat.VATPanel_VATUiBinderImpl_GenBundle) GWT.create(com.numhero.client.mvp.report.vat.VATPanel_VATUiBinderImpl_GenBundle.class);
    java.lang.String domId0 = com.google.gwt.dom.client.Document.get().createUniqueId();
    java.lang.String domId1 = com.google.gwt.dom.client.Document.get().createUniqueId();
    com.numhero.client.mvp.report.vat.VATTable vatTable = (com.numhero.client.mvp.report.vat.VATTable) GWT.create(com.numhero.client.mvp.report.vat.VATTable.class);
    ...
    f_HTMLPanel2.addAndReplaceElement(vatTable, domId1Element);
