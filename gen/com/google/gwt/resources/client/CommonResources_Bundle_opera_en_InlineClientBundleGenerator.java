...
public class CommonResources_Bundle_opera_en_InlineClientBundleGenerator implements com.google.gwt.resources.client.CommonResources.Bundle {
  private static CommonResources_Bundle_opera_en_InlineClientBundleGenerator _instance0 = new CommonResources_Bundle_opera_en_InlineClientBundleGenerator();
  private void inlineBlockStyleInitializer() {
    inlineBlockStyle = new com.google.gwt.resources.client.CommonResources.InlineBlockStyle() {
      ...
      public String getText() {
        return (".GINHCA5DH{position:" + ("relative")  + ";display:" + ("inline-block")  + ";}");
      }
