...
public class MoneyOutSummaryTable extends FlexTableWithHeader {

    public MoneyOutSummaryTable() {
    ...
    public void setRecaps(Collection<MoneyInOutRecapRow> rows) {
        ...
        for (MoneyInOutRecapRow invoice : rows) {
            ...
            setText(row, 2, SharedUtils.currencyToStr(invoice.fExpensesValue.getValue().doubleValue(), 2, ClientCache.getCurrentBA().fCurrency.getValue()));
            setText(row, 3, SharedUtils.currencyToStr(invoice.fReceiptsValue.getValue().doubleValue(), 2, ClientCache.getCurrentBA().fCurrency.getValue()));
        }
    }
    ...
    protected void setHeader() {
        ...
        setHeader(2, Application.getConstants().expenses(), HasHorizontalAlignment.ALIGN_LEFT, "80px");
        setHeader(3, Application.getConstants().receipts(), HasHorizontalAlignment.ALIGN_LEFT, "80px");
    }
}
